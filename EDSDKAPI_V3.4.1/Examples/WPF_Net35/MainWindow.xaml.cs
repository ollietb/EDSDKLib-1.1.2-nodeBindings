...
namespace WPF_Net35
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void PhotoButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                if ((string)TvCoBox.SelectedItem == "Bulb") MainCamera.TakePhoto(BulbTime * 1000);
        ...
        {
            try { Dispatcher.Invoke((Action)delegate { RefreshCameras(); }); }
            catch (Exception ex) { ShowError(ex); }
        }
        ...
        private void MainCamera_LiveViewStopped(Camera sender)
        {
            try
            {
                ...
                LVButton.Dispatcher.Invoke((Action)delegate
                {
                    LVButton.Content = "Start Live View";
        ...
        private void MainCamera_FileDownloaded(object sender, string Value)
        {
